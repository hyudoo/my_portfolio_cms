    ...
    () =>
      z
        .object({
          ...
          password: z.string().min(1, t('validation.password_required')).min(8, t('validation.password_min_length')),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" noValidate>
          <div className="grid grid-cols-2 gap-4">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input placeholder={t('register.name_placeholder')} className="h-11 pl-9" {...field} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">{t('register.username')}</FormLabel>
                  <FormControl>
                    <div className="relative">
                      <AtSign className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground" />
                      <Input placeholder={t('register.username_placeholder')} className="h-11 pl-9" {...field} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">{t('register.confirm_password')}</FormLabel>
                <FormControl>
                  <InputPassword placeholder={t('register.confirm_password_placeholder')} className="h-11" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
